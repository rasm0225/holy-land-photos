...
| URL | Description |
|---|---|
| `/mockups/turkey.html` | Turkey — top-level region |
| `/mockups/western-turkey.html` | Western Turkey — sub-region |
| `/mockups/aegean.html` | Central & Southern Aegean — sub-region |
| `/mockups/smyrna.html` | Smyrna/Izmir — site info page |
| `/mockups/photos/TWCSSM*.html` | 14 individual photo pages |
