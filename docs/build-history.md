# HolyLandPhotos.org — Build History

*Archived 2026-05-19 — historical context from the migration/build phase.*

This file captures the decisions, audits, and inventories that shaped the rebuild of holylandphotos.org. It is no longer load-bearing for day-to-day work — those rules live in [CLAUDE.md](../CLAUDE.md) — but it is kept here as a reference for why the site is the way it is.
