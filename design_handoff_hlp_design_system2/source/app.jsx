...
function App() {
  return (
    <DesignCanvas>
      ...
      <DCSection
        id="r2-overlays"
        title="Round 2 · Overlays"
        subtitle="Lightbox, download/copyright modal, and mobile drawer. Each overlay is shown over a blurred page underneath so you can see how it sits in context."
      >
        <DCArtboard id="r2-lightbox" label="Lightbox · photo open" width={W} height={H_PHOTO}><PlainLightboxDemo /></DCArtboard>
        <DCArtboard id="r2-dlmodal"  label="Download · copyright modal" width={W} height={H_PHOTO}><PlainDownloadModalDemo /></DCArtboard>
        <DCArtboard id="r2-drawer"   label="Mobile · hamburger drawer open" width={MW} height={MH}>
          <MobileFrame><MobileDrawerDemo /></MobileFrame>
        </DCArtboard>
      </DCSection>
      ...
      <DCSection
        id="r2-pages"
        title="Round 2 · Pages"
        subtitle="AI Search full page + Newsletter form (idle / error / success / loading) + Print preview."
      >
        <DCArtboard id="r2-aisearch" label="AI Search · full page"  width={W} height={1500}><PlainAISearchPage /></DCArtboard>
        <DCArtboard id="r2-nl-idle"  label="Newsletter · idle"      width={W} height={1100}><PlainNewsletter state="idle" /></DCArtboard>
        <DCArtboard id="r2-nl-error" label="Newsletter · error"     width={W} height={1100}><PlainNewsletter state="error" /></DCArtboard>
        <DCArtboard id="r2-nl-success" label="Newsletter · success" width={W} height={1100}><PlainNewsletter state="success" /></DCArtboard>
        <DCArtboard id="r2-print"    label="Print preview · photo page" width={900} height={1300}><PlainPrintPreview /></DCArtboard>
      </DCSection>
    </DesignCanvas>
  );
}
  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        fontSize: 11.5, letterSpacing: "0.18em", textTransform: "uppercase",
        color: "#8a8378", margin: "0 0 6px",
      }}>For Peter · v4 (Round 2) · May 2026</p>
      <h1 style={{ fontSize: 30, fontWeight: 600, lineHeight: 1.15, margin: "0 0 14px" }}>
        Overlays, AI page, newsletter, print.
      </h1>
      <p style={{ margin: "0 0 14px", color: "#4a453e" }}>
        Six items from Claude Code's Round 2 brief. Scroll past the Round 1 work
        to find the new sections at the bottom — <strong>Round 2 · Overlays</strong> and{" "}
        <strong>Round 2 · Pages</strong>.
      </p>
      <p style={{ margin: "0 0 14px", color: "#4a453e" }}>
